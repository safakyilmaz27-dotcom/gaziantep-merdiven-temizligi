...
- Kod içindeki tüm `https://gaziantepapartmanvemerdiventemizligi.com/` adresleri hazır;
...
- `sitemap.xml` dosyasını gönderin (Sitemaps > `https://gaziantepapartmanvemerdiventemizligi.com/sitemap.xml`).
